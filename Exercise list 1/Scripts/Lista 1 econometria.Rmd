...
```{r}
  ...
  V_clustered <- solve(xx)%*%omega%*%solve(xx)
...
```         
                 intercept   experience experiencesqr       female
intercept     2.311598e+27 8.225988e+28  3.155699e+30 9.901356e+26
experience    8.225988e+28 2.927277e+30  1.122978e+32 3.523469e+28
experiencesqr 3.155699e+30 1.122978e+32  4.308032e+33 1.351693e+30
female        9.901356e+26 3.523469e+28  1.351693e+30 4.241086e+26
education     3.236150e+28 1.151608e+30  4.417861e+31 1.386153e+28
                 education
intercept     3.236150e+28
experience    1.151608e+30
experiencesqr 4.417861e+31
female        1.386153e+28
education     4.530490e+29
```
...
```         
    intercept    experience experiencesqr        female     education 
 4.807908e+13  1.710929e+15  6.563560e+16  2.059390e+13  6.730891e+14 
```
...
5.  Consider a 18 years-old prospective college student deciding whether to study or work. He wants to know the *ratio* 𝜭 between returns of education and returns to experience, given his age. Write 𝜭 as a function of the parameters 𝞫 and estimate it.
    ...
    ```{r}
    teta <- βhat[5,1]/(βhat[2,1] + 6*βhat[3,1]) #betas from the regression ln(earnings) = Intercept + 𝞫1 experience + 𝞫2 experience2 + 𝞫3 female + 𝞫4 educ
    ```
...
V~𝜭~ = 0.00058 and the s(V~𝜭~) = 0.024
